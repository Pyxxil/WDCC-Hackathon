          ...
          <section className="container-features">
            ...
            <div className="container-features-grid">
              <div>
                <img src="/img/cal.svg" />
                <p>
                  <h4>Calendar:</h4> {/* add logo of calendar */} Keep track of
                  your assignments and upcoming events.
                </p>
              </div>
              <div>
                <img src="/img/profile.svg" />
                <p>
                  <h4>Personalized:</h4> {/* add logo of a tick */} Tell us your
                  goals and let us personalize all the events for you.{" "}
                </p>
              </div>
              <div>
                <img src="/img/info.svg" />
                <p>
                  <h4>Consolidated Information:</h4> {/* add logo of a tick */}{" "}
                  Information at the touch of your fingers, curated by us.{" "}
                </p>
              </div>
              <div>
                <img src="/img/event.svg" />
                <p>
                  <h4>Events:</h4> {/* add logo of a tick */} See relevant
                  career workshops and club events.{" "}
                </p>
              </div>
            </div>
          </section>
