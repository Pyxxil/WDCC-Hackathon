    ...
    <div>
      <Layout user={user} loading={loading}>
        <form id="forJob">
          ...
          <span>Company</span><input onChange={handleChange} id="Company"></input><br/>
          <span>Description</span><input onChange={handleChange} id="Description"></input><br/>
          <span>Application Start</span><input onChange={handleChange} id="DateStart"></input><br/>
          <span>Application End</span><input onChange={handleChange} id="DateStart"></input><br/>
